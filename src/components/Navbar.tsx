...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 h-20 flex justify-center items-center text-xl sticky top-0 z-50 shadow-md">
      <div className="flex justify-between items-center w-full max-w-7xl px-12 max-md:px-5">
        <Link 
          to="/" 
          className="text-white cursor-pointer no-underline text-3xl max-md:text-xl font-bold hover:text-indigo-500 transition-colors duration-300" 
          onClick={closeMenu}
        >
          GoFishTalent
        </Link>
