  ...
  return (
    <nav className='font-slackey bg-[var(--primary)] h-20 flex justify-center items-center text-xl sticky top-0 z-50 shadow-md'>
      <div className='flex justify-between items-center w-full max-w-7xl px-12 max-md:px-5'>
        <Link
          to='/'
          className='flex gap-2 text-[var(--light)] cursor-pointer no-underline text-3xl max-md:text-xl font-bold hover:text-white transition-colors duration-300'
          onClick={closeMenu}
        >
          <img
            src={GFTLogo}
        ...
        <div className='md:hidden cursor-pointer' onClick={toggleMenu}>
          <div className='w-8 h-6 relative flex flex-col justify-between'>
            <span
              className={`block h-0.5 w-full bg-[var(--light)] rounded transition-all duration-300 ease-in-out ${
        ...
        <ul
          ...
          `}
        >
          <li className='h-20 flex items-center max-md:w-full max-md:h-16 max-md:border-b max-md:border-[var(--light)]/20'>
            <Link
              to='/talent'
              className='text-[var(--light)] no-underline px-4 py-2 h-full flex items-center transition-all duration-300 border-b-4 border-transparent hover:text-white hover:border-[var(--light)] max-md:w-full max-md:py-6 max-md:justify-center max-md:border-b-0 max-md:hover:bg-[#FF9F5C]'
              onClick={closeMenu}
            >
              Talent
            </Link>
